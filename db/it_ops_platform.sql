...
CREATE TABLE `it_ticket`  (
  ...
  `status` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending' COMMENT '工单状态：pending待受理，assigned已派单，processing处理中，completed已完成，cancelled已取消',
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `assigned_at` datetime NULL DEFAULT NULL COMMENT '派单时间',
...
-- ----------------------------
INSERT INTO `it_ticket` VALUES (1, 'TK202606210001', '财务电脑无法开机', '按下电源键后电脑无反应，显示器无信号。', 'hardware', 'high', 'completed', 3, 2, 1, '重新插拔内存并清理主板灰尘后恢复正常。', '2026-06-21 09:10:00', '2026-06-21 09:20:00', '2026-06-21 09:30:00', '2026-06-21 10:10:00', '2026-06-21 09:40:00', '2026-06-21 13:10:00', '2026-06-21 09:20:00', '2026-06-21 10:10:00', 0, 0, '2026-06-22 19:39:11');
INSERT INTO `it_ticket` VALUES (2, 'TK202606210002', '运营部打印机卡纸', '打印合同时频繁卡纸，影响正常办公。', 'printer', 'normal', 'completed', 4, 2, 2, '清理纸道并更换搓纸轮后恢复正常。', '2026-06-21 10:00:00', '2026-06-21 10:15:00', '2026-06-21 10:30:00', '2026-06-21 11:00:00', '2026-06-21 11:00:00', '2026-06-21 18:00:00', '2026-06-21 10:15:00', '2026-06-21 11:00:00', 0, 0, '2026-06-22 19:39:11');
INSERT INTO `it_ticket` VALUES (3, 'TK202606210003', '部分电脑访问内网系统较慢', '多个用户反馈访问ERP系统时页面加载缓慢。', 'network', 'urgent', 'completed', 3, 2, 3, '排查发现交换机端口异常，调整端口并重启相关网络设备后恢复。', '2026-06-21 11:20:00', '2026-06-21 11:25:00', '2026-06-21 11:30:00', '2026-06-21 12:10:00', '2026-06-21 11:25:00', '2026-06-21 12:20:00', '2026-06-21 11:25:00', '2026-06-21 12:10:00', 0, 0, '2026-06-22 19:39:11');
INSERT INTO `it_ticket` VALUES (4, 'TK202606210004', '办公软件无法正常启动', '打开Excel后提示组件加载失败。', 'software', 'normal', 'pending', 4, NULL, 1, NULL, '2026-06-21 14:00:00', NULL, NULL, NULL, '2026-06-21 15:00:00', '2026-06-21 22:00:00', NULL, NULL, 0, 0, '2026-06-22 19:39:11');
INSERT INTO `it_ticket` VALUES (5, 'TK202606230001', '电脑无法开机', '就是电脑无法开机', 'hardware', 'normal', 'cancelled', 1, NULL, NULL, NULL, '2026-06-23 00:29:35', NULL, NULL, NULL, '2026-06-23 01:29:35', '2026-06-23 08:29:35', NULL, NULL, 0, 0, '2026-06-23 00:52:15');
INSERT INTO `it_ticket` VALUES (6, 'TK202606230002', '打印机无法打印', '打印机无法打印', 'hardware', 'normal', 'pending', 2, NULL, NULL, NULL, '2026-06-23 01:42:31', NULL, NULL, NULL, '2026-06-23 02:42:31', '2026-06-23 09:42:31', NULL, NULL, 0, 0, '2026-06-23 01:42:31');
